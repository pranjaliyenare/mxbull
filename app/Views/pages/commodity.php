          ...
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="100">
            <div class="member d-flex align-items-start">
              ...
              <table>
                ...
                <tbody>
                    <tr>
                    <td data-label="Product">UK Crude (Cash)</td>
                    <td data-label="Margin Per System Lot">From 2%</td>
                    <td data-label="Average Spread">0.3</td>
                    <td data-label="Trading Hours & Timing = GMT + 2">Monday 01:00 - Friday 00:00 (Mon - Thurs Break: 00 :00- 01:00)</td>
                    </tr>
                    <tr>
                    <td scope="row" data-label="Product">US Crude (Cash)</td>
                    <td data-label="Margin Per System Lot">From 2%</td>
                    <td data-label="Average Spread">0.3</td>
                    <td data-label="Trading Hours & Timing = GMT + 2">Monday 01:00 - Friday 00:00 (Mon - Thurs Break: 00 :00- 01:00)</td>
                    </tr>
